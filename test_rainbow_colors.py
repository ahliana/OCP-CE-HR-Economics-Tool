"""
Test rainbow spectrum color scheme for pie charts
"""
...
print("=" * 80)
print("RAINBOW SPECTRUM COLOR SCHEME TEST")
print("=" * 80)
...
for idx, (approach, title) in enumerate(zip(approaches, titles)):
    ...
    # Create pie chart with rainbow colors
...
output_file = 'rainbow_color_scheme.png'
plt.savefig(output_file, dpi=150, bbox_inches='tight')
plt.close()

print(f"\n✓ Chart with rainbow colors saved to: {output_file}")

print("\n" + "=" * 80)
print("RAINBOW SPECTRUM PROPERTIES")
print("=" * 80)
print("\n🌈 Color Distribution (ROYGBP):")
print("   🔴 Red (#E74C3C) - Heat Exchangers")
print("   🟠 Orange (#FF9F43) - Pumps")
print("   🟡 Yellow (#F1C40F) - Piping & Fittings")
print("   🟢 Green (#2ECC71) - Instrumentation")
print("   🔵 Blue (#3498DB) - Valves")
print("   🟣 Purple (#9B59B6) - I&C Subtotal")
print("\nClassic rainbow spectrum - maximum color separation!")
print("Highly visible and instantly recognizable pattern.")
print("=" * 80)
