"""
Test custom color scheme for pie charts
"""
...
print("=" * 80)
print("CUSTOM COLOR SCHEME TEST")
print("=" * 80)
...
for i, (label, color, color_name) in enumerate(zip(labels, colors, color_names)):
    print(f"  {i+1}. {label:<25} → {color_name:<20} ({color})")
...
output_file = 'custom_color_scheme.png'
plt.savefig(output_file, dpi=150, bbox_inches='tight')
plt.close()

print(f"\n✓ Chart with custom colors saved to: {output_file}")

print("\n" + "=" * 80)
print("COLOR PALETTE BREAKDOWN")
print("=" * 80)
print("\nColor Distribution:")
print("  • Medium Blue (#4A90E2) - Heat Exchangers")
print("  • Rose Red (#E67373) - Pumps")
print("  • Grass Green (#5FB878) - Piping & Fittings")
print("  • Amber (#F5A623) - Instrumentation")
print("  • Medium Purple (#A569BD) - Valves")
print("  • Charcoal Gray (#52616B) - I&C Subtotal")
print("\nAll 6 colors are distinct and professional!")
print("=" * 80)
